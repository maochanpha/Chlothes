...
@section('title', 'Add Category | Threadline Admin')
...
@section('content')
    <section class="admin-shell">
        @include('admin.partials.sidebar', ['active' => 'addCategory'])

        <main class="admin-content">
            <div class="admin-topbar">
                <div>
                    <h1>Add Category</h1>
                    <p>Create a new clothing category for collections, moods, or product groups.</p>
                </div>
            ...
            <section class="admin-panel simple-category-form">
                <div class="panel-header">
                    <div>
                        <h2>Category Form</h2>
                        <p class="muted">Enter category name and image.</p>
                    </div>
                </div>

                <form class="admin-form" id="add-category-form" action="{{route('createCategory')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-grid">
                        <div class="form-field">
                            <label for="cate-name">Category Name</label>
                            <input id="cate-name" name="cate_name" type="text" placeholder="Enter category name">
                        </div>
